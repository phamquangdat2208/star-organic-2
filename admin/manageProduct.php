    ...
    <div class="warper" style="margin:0 auto; width:50%;">
        <div class="container">
            ...
            <form id="mng-product" action="" method="post" enctype="multipart/form-data">
                ...
                <!-- image upload -->
                <h6>Upload image (Accept only JPG, PNG and GIF file):</h6>
                <div class="input-group mb-3">
                    <input type="file" class="form-control" id="customFile" name="avatar" />
                </div>
                <!-- submit -->
                <div class="submit input-group mb3">
                    <input style="width:100px;" class="btn-add btn btn-primary" type="submit" value="Add" name="add" id="add">
                    <button style="width:100px;" class="btn-add btn btn-danger" type="reset" id="reset">Reset</button>
                </div>
            </form>
        </div>
    </div>
